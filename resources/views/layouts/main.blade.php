...
<head>
    ...
    <meta name="description" content="Catalog project">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="icon" href="{{ asset('icons8-laravel-64.png') }}" type="image/png">
...
<body>
    ...
    <div class="super_container">
        ...
        <header class="header">
                        ...
                        <div class="col">
                            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                                ...
                                <nav class="main_nav">
                                    <ul>
                                        <li>
                                            <a href={{ route('client.products.index') }}>Все товары</a>
                                        </li>
                                        <li class="hassubs">
                                            <a href="#">Категории</a>
                                            <ul>
            ...
            <footer class="footer">
                <div class="footer_background" style="background-image:url('{{ asset('images/footer.jpg') }}')">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col">
